...
public class soal extends JFrame{
	...
	JLabel per1 = new JLabel("1. RIGID >< ....");
	JRadioButton rad1a = new JRadioButton("(A) Standar");
	JRadioButton rad1b = new JRadioButton ("(B) 	Kaku");
	JRadioButton rad1c = new JRadioButton("(C) 	Keras");
	JRadioButton rad1d = new JRadioButton ("(D) 	Negosiasi");
	JRadioButton rad1e = new JRadioButton ("(E) 	Fleksibel");
	
	JLabel per2 = new JLabel("2. PARSIMONI >< ....");
	JRadioButton rad2a = new JRadioButton("(A) Hemat");
	JRadioButton rad2b = new JRadioButton ("(B) 	Irit");
	JRadioButton rad2c = new JRadioButton("(C) 	Tinggi");
	JRadioButton rad2d = new JRadioButton ("(D) 	Boros");
	JRadioButton rad2e = new JRadioButton ("(E) 	Harmoni");
	
	JLabel per3 = new JLabel("3. GENERIK >< ....");
	JRadioButton rad3a = new JRadioButton("(A) Mahal");
	JRadioButton rad3b = new JRadioButton ("(B) 	Khusus");
	JRadioButton rad3c = new JRadioButton("(C) 	Ampuh");
	JRadioButton rad3d = new JRadioButton ("(D) 	Individu");
	JRadioButton rad3e = new JRadioButton ("(E) 	Umum");
	
	JLabel per4 = new JLabel("4. PANGKAL >< ....");
	JRadioButton rad4a = new JRadioButton("(A) Pokok");
	JRadioButton rad4b = new JRadioButton ("(B) 	Awal");
	JRadioButton rad4c = new JRadioButton("(C) 	Permulaan");
	JRadioButton rad4d = new JRadioButton ("(D) 	Akhir");
	JRadioButton rad4e = new JRadioButton ("(E) 	Asal muasal");
	
	JLabel per5 = new JLabel("5. PREMAN >< ....");
	JRadioButton rad5a = new JRadioButton("(A) Dinas");
	JRadioButton rad5b = new JRadioButton ("(B) 	Sendiri");
	JRadioButton rad5c = new JRadioButton("(C) 	Pengawal");
	JRadioButton rad5d = new JRadioButton ("(D) 	Partikelir");
	JRadioButton rad5e = new JRadioButton ("(E) 	Swasta");
	
	JLabel per6 = new JLabel("6. CAPEK >< ....");
	JRadioButton rad6a = new JRadioButton("(A) Penat");
	JRadioButton rad6b = new JRadioButton ("(B) 	Letih");
	JRadioButton rad6c = new JRadioButton("(C) 	Lelah");
	JRadioButton rad6d = new JRadioButton ("(D) 	Segar");
	JRadioButton rad6e = new JRadioButton ("(E) 	Damai");
	
	JLabel per7 = new JLabel("7. ULTIMA >< ....");
	JRadioButton rad7a = new JRadioButton("(A) Penutup");
	JRadioButton rad7b = new JRadioButton ("(B) 	Final");
	JRadioButton rad7c = new JRadioButton("(C) 	Kesan");
	JRadioButton rad7d = new JRadioButton ("(D) 	Biasa");
	JRadioButton rad7e = new JRadioButton ("(E) 	Awal");
	
	JLabel per8 = new JLabel("8. GENTAR >< ....");
	JRadioButton rad8a = new JRadioButton("(A) Ragu");
	JRadioButton rad8b = new JRadioButton ("(B) 	Takut");
	JRadioButton rad8c = new JRadioButton("(C) 	Berani");
	JRadioButton rad8d = new JRadioButton ("(D) 	Tantang");
	JRadioButton rad8e = new JRadioButton ("(E) 	Menantang");
	
	JLabel per9 = new JLabel("9. PROFIT >< ....");
	JRadioButton rad9a = new JRadioButton("(A) Untung");
	JRadioButton rad9b = new JRadioButton ("(B) 	Bonus");
	JRadioButton rad9c = new JRadioButton("(C) 	Rugi");
	JRadioButton rad9d = new JRadioButton ("(D) 	Bunga");
	JRadioButton rad9e = new JRadioButton ("(E) 	Hadiah");
	
	JLabel per10 = new JLabel("10. PERLOP >< ....");
	JRadioButton rad10a = new JRadioButton("(A) Cuti");
	JRadioButton rad10b = new JRadioButton ("(B) 	Masuk");
	JRadioButton rad10c = new JRadioButton("(C) 	Kerja");
	JRadioButton rad10d = new JRadioButton ("(D) 	Datang");
	JRadioButton rad10e = new JRadioButton ("(E) 	Absen");
	
	JLabel per11 = new JLabel("11. PREMATUR >< ....");
	JRadioButton rad11a = new JRadioButton("(A) Dini");
	JRadioButton rad11b = new JRadioButton ("(B) 	Kecil");
	JRadioButton rad11c = new JRadioButton("(C) 	Besar");
	JRadioButton rad11d = new JRadioButton ("(D) 	Terlambat");
	JRadioButton rad11e = new JRadioButton ("(E) 	Tercepat");
	
	JLabel per12 = new JLabel("12. NAHAS >< ....");
	JRadioButton rad12a = new JRadioButton("(A) Nasib buruk");
	JRadioButton rad12b = new JRadioButton ("(B) 	Malang");
	JRadioButton rad12c = new JRadioButton("(C) 	Celaka");
	JRadioButton rad12d = new JRadioButton ("(D) 	Untung");
	JRadioButton rad12e = new JRadioButton ("(E) 	Sial");
	
	JLabel per13 = new JLabel("13. ABSEN >< ....");
	JRadioButton rad13a = new JRadioButton("(A) Sakit");
	JRadioButton rad13b = new JRadioButton ("(B) 	Masuk");
	JRadioButton rad13c = new JRadioButton("(C) 	Izin");
	JRadioButton rad13d = new JRadioButton ("(D) 	Hadir");
	JRadioButton rad13e = new JRadioButton ("(E) 	Cuti");
	
	JLabel per14 = new JLabel("14. CHAOS >< ....");
	JRadioButton rad14a = new JRadioButton("(A) Labil");
	JRadioButton rad14b = new JRadioButton ("(B) 	Hancur");
	JRadioButton rad14c = new JRadioButton("(C) 	Normal");
	JRadioButton rad14d = new JRadioButton ("(D) 	Kacau");
	JRadioButton rad14e = new JRadioButton ("(E) 	Abnormal");
	
	JLabel per15 = new JLabel("15. KONSTAN >< ....");
	JRadioButton rad15a = new JRadioButton("(A) Bertentangan");
	JRadioButton rad15b = new JRadioButton ("(B) 	Berubah-ubah");
	JRadioButton rad15c = new JRadioButton("(C) 	Stabil");
	JRadioButton rad15d = new JRadioButton ("(D) 	Berbeda-beda");
	JRadioButton rad15e = new JRadioButton ("(E) 	Stagnan");
	
	JLabel per16 = new JLabel("16. DELUSI >< ....");
	JRadioButton rad16a = new JRadioButton("(A) Ilusi");
	JRadioButton rad16b = new JRadioButton ("(B) 	Nyata");
	JRadioButton rad16c = new JRadioButton("(C) 	Khayalan");
	JRadioButton rad16d = new JRadioButton ("(D) 	Fiksi");
	JRadioButton rad16e = new JRadioButton ("(E) 	Fantasi");
	
	JLabel per17 = new JLabel("17. INDEPENDEN >< ....");
	JRadioButton rad17a = new JRadioButton("(A) Tidak bergantung kepada orang lain");
	JRadioButton rad17b = new JRadioButton ("(B) 	Dependen");
	JRadioButton rad17c = new JRadioButton("(C) 	Berdiri sendiri");
	JRadioButton rad17d = new JRadioButton ("(D) 	Bekerja mandiri");
	JRadioButton rad17e = new JRadioButton ("(E) 	Swadaya");
	
	JLabel per18 = new JLabel("18. NADIR >< ....");
	JRadioButton rad18a = new JRadioButton("(A) Absen");
	JRadioButton rad18b = new JRadioButton ("(B) 	Ada");
	JRadioButton rad18c = new JRadioButton("(C) 	Pindah");
	JRadioButton rad18d = new JRadioButton ("(D) 	Tampak");
	JRadioButton rad18e = new JRadioButton ("(E) 	Masuk");
	
	JLabel per19 = new JLabel("19. MANDIRI >< ....");
	JRadioButton rad19a = new JRadioButton("(A) Senang");
	JRadioButton rad19b = new JRadioButton ("(B) 	Memihak");
	JRadioButton rad19c = new JRadioButton("(C) 	Bergantung");
	JRadioButton rad19d = new JRadioButton ("(D) 	Antipati");
	JRadioButton rad19e = new JRadioButton ("(E) 	Tenggang rasa");
	
	JLabel per20 = new JLabel("20. ABSTRAK >< ....");
	JRadioButton rad20a = new JRadioButton("(A) Gaib");
	JRadioButton rad20b = new JRadioButton ("(B) 	Kacau");
	JRadioButton rad20c = new JRadioButton("(C) 	Konkret");
	JRadioButton rad20d = new JRadioButton ("(D) 	Samar");
	JRadioButton rad20e = new JRadioButton ("(E) 	Tidak nyata");
	
	JLabel per21 = new JLabel("21. PERINTIS >< ....");
	JRadioButton rad21a = new JRadioButton("(A) Pendahulu");
	JRadioButton rad21b = new JRadioButton ("(B) 	Pewaris");
	JRadioButton rad21c = new JRadioButton("(C) 	Generasi");
	JRadioButton rad21d = new JRadioButton ("(D) 	Olok-olok");
	JRadioButton rad21e = new JRadioButton ("(E) 	Tertawa");
	
	JLabel per22 = new JLabel("22. LEMBAH >< ....");
	JRadioButton rad22a = new JRadioButton("(A) Ngarai");
	JRadioButton rad22b = new JRadioButton ("(B) 	Tebing");
	JRadioButton rad22c = new JRadioButton("(C) 	Bukit");
	JRadioButton rad22d = new JRadioButton ("(D) 	Jurang");
	JRadioButton rad22e = new JRadioButton ("(E) 	Sungai");
	
	JLabel per23 = new JLabel("23. ANTIPATI >< ....");
	JRadioButton rad23a = new JRadioButton("(A) Simpati");
	JRadioButton rad23b = new JRadioButton ("(B) 	Kalipati");
	JRadioButton rad23c = new JRadioButton("(C) 	Untipati");
	JRadioButton rad23d = new JRadioButton ("(D) 	Tertolak");
	JRadioButton rad23e = new JRadioButton ("(E) 	Benci");
	
	JLabel per24 = new JLabel("24. MUSKIL >< ....");
	JRadioButton rad24a = new JRadioButton("(A) Mustahil");
	JRadioButton rad24b = new JRadioButton ("(B) 	Mungkin");
	JRadioButton rad24c = new JRadioButton("(C) 	Anti Tuhan");
	JRadioButton rad24d = new JRadioButton ("(D) 	Bohong");
	JRadioButton rad24e = new JRadioButton ("(E) 	Kepastian");
	
	JLabel per25 = new JLabel("25. SPORADIS >< ....");
	JRadioButton rad25a = new JRadioButton("(A) Spontan");
	JRadioButton rad25b = new JRadioButton ("(B) 	Sering");
	JRadioButton rad25c = new JRadioButton("(C) 	Jarang");
	JRadioButton rad25d = new JRadioButton ("(D) 	Mungkin");
	JRadioButton rad25e = new JRadioButton ("(E) 	Kontinu");
	
	JLabel per26 = new JLabel("26. OFENSIF >< ....");
	JRadioButton rad26a = new JRadioButton("(A) Pertahanan");
	JRadioButton rad26b = new JRadioButton ("(B) 	Pemanas");
	JRadioButton rad26c = new JRadioButton("(C) 	Agresif");
	JRadioButton rad26d = new JRadioButton ("(D) 	Menyerang");
	JRadioButton rad26e = new JRadioButton ("(E) 	Offical");
	
	JLabel per27 = new JLabel("27. LONGGAR >< ....");
	JRadioButton rad27a = new JRadioButton("(A) Sepi");
	JRadioButton rad27b = new JRadioButton ("(B) 	Ramai");
	JRadioButton rad27c = new JRadioButton("(C) 	Tegas");
	JRadioButton rad27d = new JRadioButton ("(D) 	Lugas");
	JRadioButton rad27e = new JRadioButton ("(E) 	Permisif");
	
	JLabel per28 = new JLabel("28. ABADI >< ....");
	JRadioButton rad28a = new JRadioButton("(A) Nyata");
	JRadioButton rad28b = new JRadioButton ("(B) 	Kekal");
	JRadioButton rad28c = new JRadioButton("(C) 	Sementara");
	JRadioButton rad28d = new JRadioButton ("(D) 	Baka");
	JRadioButton rad28e = new JRadioButton ("(E) 	Semu");
	
	JLabel per29 = new JLabel("29. PERTEMUAN >< ....");
	JRadioButton rad29a = new JRadioButton("(A) Kemunculan");
	JRadioButton rad29b = new JRadioButton ("(B) 	Perpisahan");
	JRadioButton rad29c = new JRadioButton("(C) 	Pertemanan");
	JRadioButton rad29d = new JRadioButton ("(D) 	Kematian");
	JRadioButton rad29e = new JRadioButton ("(E) 	Kelahiran");
	
	JLabel per30 = new JLabel("30. FONEM >< ....");
	JRadioButton rad30a = new JRadioButton("(A) Kalimat");
	JRadioButton rad30b = new JRadioButton ("(B) 	Morfem");
	JRadioButton rad30c = new JRadioButton("(C) 	Teks");
	JRadioButton rad30d = new JRadioButton ("(D) 	Vocal");
	JRadioButton rad30e = new JRadioButton ("(E) 	Verbal");
	
	JLabel per31 = new JLabel("31. LECO >< ....");
	JRadioButton rad31a = new JRadioButton("(A) Kuasa");
	JRadioButton rad31b = new JRadioButton ("(B) 	Raksasa");
	JRadioButton rad31c = new JRadioButton("(C) 	Monster");
	JRadioButton rad31d = new JRadioButton ("(D) 	Sangar");
	JRadioButton rad31e = new JRadioButton ("(E) 	Beringas");
	
	JLabel per32 = new JLabel("32. BERSIMBAH >< ....");
	JRadioButton rad32a = new JRadioButton("(A) Kering");
	JRadioButton rad32b = new JRadioButton ("(B) 	Bercak");
	JRadioButton rad32c = new JRadioButton("(C) 	Basah");
	JRadioButton rad32d = new JRadioButton ("(D) 	Berdarah");
	JRadioButton rad32e = new JRadioButton ("(E) 	Bersih");
	
	JLabel per33 = new JLabel("33. KEBIJAKAN >< ....");
	JRadioButton rad33a = new JRadioButton("(A) Kepentingan");
	JRadioButton rad33b = new JRadioButton ("(B) 	Kebijaksanaan");
	JRadioButton rad33c = new JRadioButton("(C) 	Keadilan");
	JRadioButton rad33d = new JRadioButton ("(D) 	Kecerobohan");
	JRadioButton rad33e = new JRadioButton ("(E) 	Kesesatan");
	
	JLabel per34 = new JLabel("34. LOYAL >< ....");
	JRadioButton rad34a = new JRadioButton("(A) Taat");
	JRadioButton rad34b = new JRadioButton ("(B) 	Khianat");
	JRadioButton rad34c = new JRadioButton("(C) 	Hemat");
	JRadioButton rad34d = new JRadioButton ("(D) 	Umum");
	JRadioButton rad34e = new JRadioButton ("(E) 	Boros");
	
	JLabel per35 = new JLabel("35. EKLEKTIK >< ....");
	JRadioButton rad35a = new JRadioButton("(A) Spritual");
	JRadioButton rad35b = new JRadioButton ("(B) 	Tak pilih-pilih");
	JRadioButton rad35c = new JRadioButton("(C) 	Konklusif");
	JRadioButton rad35d = new JRadioButton ("(D) 	Radikal");
	JRadioButton rad35e = new JRadioButton ("(E) 	Frontal");
	
	JLabel per36 = new JLabel("36. KELUK >< ....");
	JRadioButton rad36a = new JRadioButton("(A) Curam");
	JRadioButton rad36b = new JRadioButton ("(B) 	Landai");
	JRadioButton rad36c = new JRadioButton("(C) 	Samping");
	JRadioButton rad36d = new JRadioButton ("(D) 	Lurus");
	JRadioButton rad36e = new JRadioButton ("(E) 	Belok");
	
	JLabel per37 = new JLabel("37. JENJAM >< ....");
	JRadioButton rad37a = new JRadioButton("(A) Santai");
	JRadioButton rad37b = new JRadioButton ("(B) 	Kecewa");
	JRadioButton rad37c = new JRadioButton("(C) 	Marah");
	JRadioButton rad37d = new JRadioButton ("(D) 	Sedih");
	JRadioButton rad37e = new JRadioButton ("(E) 	Khawatir");
	
	JLabel per38 = new JLabel("38. NIRLABA >< ....");
	JRadioButton rad38a = new JRadioButton("(A) Deposito");
	JRadioButton rad38b = new JRadioButton ("(B) 	Tunai");
	JRadioButton rad38c = new JRadioButton("(C) 	Rugi");
	JRadioButton rad38d = new JRadioButton ("(D) 	Profit");
	JRadioButton rad38e = new JRadioButton ("(E) 	Kredit");
	
	JLabel per39 = new JLabel("39. KASANG >< ....");
	JRadioButton rad39a = new JRadioButton("(A) Arus");
	JRadioButton rad39b = new JRadioButton ("(B) 	Meluap");
	JRadioButton rad39c = new JRadioButton("(C) 	Basah");
	JRadioButton rad39d = new JRadioButton ("(D) 	Kering");
	JRadioButton rad39e = new JRadioButton ("(E) 	Air");
	
	JLabel per40 = new JLabel("40. KESEMPATAN >< ....");
	JRadioButton rad40a = new JRadioButton("(A) Hambatan");
	JRadioButton rad40b = new JRadioButton ("(B) 	Masalah");
	JRadioButton rad40c = new JRadioButton("(C) 	Peluang");
	JRadioButton rad40d = new JRadioButton ("(D) 	Keuntungan");
	JRadioButton rad40e = new JRadioButton ("(E) 	Pendorong");
	
	JLabel per41 = new JLabel("41. MAYOR >< ....");
	JRadioButton rad41a = new JRadioButton("(A) Junior");
	JRadioButton rad41b = new JRadioButton ("(B) 	Minor");
	JRadioButton rad41c = new JRadioButton("(C) 	Minim");
	JRadioButton rad41d = new JRadioButton ("(D) 	Mikro");
	JRadioButton rad41e = new JRadioButton ("(E) 	Besar");
	
	JLabel per42 = new JLabel("42. REMISI >< ....");
	JRadioButton rad42a = new JRadioButton("(A) Pengurangan");
	JRadioButton rad42b = new JRadioButton ("(B) 	Penambahan");
	JRadioButton rad42c = new JRadioButton("(C) 	Persetujuan");
	JRadioButton rad42d = new JRadioButton ("(D) 	Perubahan");
	JRadioButton rad42e = new JRadioButton ("(E) 	Inkripsi");
	
	JLabel per43 = new JLabel("43. MONOTON >< ....");
	JRadioButton rad43a = new JRadioButton("(A) Terus-menerus");
	JRadioButton rad43b = new JRadioButton ("(B) 	Diam");
	JRadioButton rad43c = new JRadioButton("(C) 	Berganti-ganti");
	JRadioButton rad43d = new JRadioButton ("(D) 	Jenuh");
	JRadioButton rad43e = new JRadioButton ("(E) 	Bertukaran");
	
	JLabel per44 = new JLabel("44. KRUSIAL >< ....");
	JRadioButton rad44a = new JRadioButton("(A) Penting");
	JRadioButton rad44b = new JRadioButton ("(B) 	Berharga");
	JRadioButton rad44c = new JRadioButton("(C) 	Berarti");
	JRadioButton rad44d = new JRadioButton ("(D) 	Sepele");
	JRadioButton rad44e = new JRadioButton ("(E) 	Makna");
	
	JLabel per45 = new JLabel("45. PROMINEN >< ....");
	JRadioButton rad45a = new JRadioButton("(A) Anggun");
	JRadioButton rad45b = new JRadioButton ("(B) 	Biasa");
	JRadioButton rad45c = new JRadioButton("(C) 	Mewah");
	JRadioButton rad45d = new JRadioButton ("(D) 	Tetap");
	JRadioButton rad45e = new JRadioButton ("(E) 	Sementara");
	
	JLabel per46 = new JLabel("46. SKEPTIS >< ....");
	JRadioButton rad46a = new JRadioButton("(A) Ragu-ragu");
	JRadioButton rad46b = new JRadioButton ("(B) 	Presangka buruk");
	JRadioButton rad46c = new JRadioButton("(C) 	Rancangan");
	JRadioButton rad46d = new JRadioButton ("(D) 	Ahli");
	JRadioButton rad46e = new JRadioButton ("(E) 	Optimis");
	
	JLabel per47 = new JLabel("47. HUNI >< ....");
	JRadioButton rad47a = new JRadioButton("(A) Ramai");
	JRadioButton rad47b = new JRadioButton ("(B) 	Banyak");
	JRadioButton rad47c = new JRadioButton("(C) 	Kosong");
	JRadioButton rad47d = new JRadioButton ("(D) 	Rumah");
	JRadioButton rad47e = new JRadioButton ("(E) 	Tinggal");
	
	JLabel per48 = new JLabel("48. DETERIORASI >< ....");
	JRadioButton rad48a = new JRadioButton("(A) Keterbelakangan");
	JRadioButton rad48b = new JRadioButton ("(B) 	Keterbalikan");
	JRadioButton rad48c = new JRadioButton("(C) 	Kemajuan");
	JRadioButton rad48d = new JRadioButton ("(D) 	Disorientasi");
	JRadioButton rad48e = new JRadioButton ("(E) 	Kemunduran");
	
	JLabel per49 = new JLabel("49. SEKULER >< ....");
	JRadioButton rad49a = new JRadioButton("(A) Ilmiah");
	JRadioButton rad49b = new JRadioButton ("(B) 	Duniawi");
	JRadioButton rad49c = new JRadioButton("(C) 	Rohaniah");
	JRadioButton rad49d = new JRadioButton ("(D) 	Anulir");
	JRadioButton rad49e = new JRadioButton ("(E) 	Keagamaan");
	
	JLabel per50 = new JLabel("50. PROPOSISI >< ....");
	JRadioButton rad50a = new JRadioButton("(A) Konklusi");
	JRadioButton rad50b = new JRadioButton ("(B) 	Reaksi");
	JRadioButton rad50c = new JRadioButton("(C) 	Tingkat");
	JRadioButton rad50d = new JRadioButton ("(D) 	Persepsi");
	JRadioButton rad50e = new JRadioButton ("(E) 	Posisi");
	...
	public soal()
	{
		super("Aplikasi Tes Polisi Arya : TIU Verbal - Tes Antonim");
		setIconImage(Toolkit.getDefaultToolkit().getImage(halaman_utama_antonim.class.getResource("icon.png")));
		setLayout(new GridLayout(1,1));
		awal.setLayout(new GridLayout(5,1));
		JLabel kop = new JLabel("TIU VERBAL: TES ANTONIM");
		JLabel antonim = new JLabel("Antonim (Lawan Kata)");
		JLabel pengertian = new JLabel("    Tes Antonim (lawan kata) ditujukan untuk menguji kemampuan seseorang dalam melihat");
		JLabel pengertian2 = new JLabel("kebenaran secara terbalik. Maksudnya adalah kemampuan dalam mengetahui sesuatunya benar");
		JLabel pengertian3 = new JLabel("atau salah tidak hanya secara fenomenologis, tetapi juga secara dialektis.");
		JLabel pengertian4 = new JLabel("   Pada tes ini, Anda dituntut untuk menguasai perbendaharaan kata sebaik mungkin. Karena ");
		...
		JLabel cont1 = new JLabel("1. CANGGIH >< ....");
		JRadioButton radconta = new JRadioButton("(A) Modern");
		JRadioButton radcontb = new JRadioButton("(B) Terlambat");
		JRadioButton radcontc = new JRadioButton("(C) Diam");
		JRadioButton radcontd = new JRadioButton("(D) Kuno");
		JRadioButton radconte = new JRadioButton("(E) Sederhana");
		...
		JLabel penjelasan1 = new JLabel("Diantara pilihan jawaban, pilihan (A) dan (D) adalah dua kata yang berlawanan. ");
		JLabel penjelasan2 = new JLabel("Karena canggih itu bermakna Modern maka antonimnya adalah kuno.");
		...
		JLabel cont12 = new JLabel("2. Mandiri >< ....");
		JRadioButton radconta2 = new JRadioButton("(A) Interaksi");
		JRadioButton radcontb2 = new JRadioButton("(B) Dependen");
		JRadioButton radcontc2 = new JRadioButton("(C) Korelasi");
		JRadioButton radcontd2 = new JRadioButton("(D) Intimidasi");
		JRadioButton radconte2 = new JRadioButton("(E) Kohesi");
		...
		JLabel penjelasan12 = new JLabel("Mandiri bermakna berdiri sendiri atau tanpa bantuan orang lain");
		JLabel penjelasan22 = new JLabel("Lawan katanya berarti bergantung kepada orang lain.");
		JLabel penjelasan23 = new JLabel("Jadi, pilihan jawaban yang paling tepat adalah dependen.");
		btnContohNext2.setFont(fsoal);
		panelPenjelasan2.setLayout(new GridLayout(3,1));
		...
		//Contoh 3
				...
				JLabel cont3 = new JLabel("3. EMIGRASI >< ....");
				JRadioButton radconta3 = new JRadioButton("(A) Urbanisasi");
				JRadioButton radcontb3 = new JRadioButton("(B) Imigrasi");
				JRadioButton radcontc3 = new JRadioButton("(C) Nomaden");
				JRadioButton radcontd3 = new JRadioButton("(D) Migrasi");
				JRadioButton radconte3 = new JRadioButton("(E) Deportasi");
				...
				JLabel penjelasan31 = new JLabel("Emigrasi adalah pindah dari tanah air sendiri ke negeri lain untuk tinggal menetap di sana.");
				...
				JLabel cont4 = new JLabel("4. SIAU >< ....");
				JRadioButton radconta4 = new JRadioButton("(A) Memual");
				JRadioButton radcontb4 = new JRadioButton("(B) Membeku");
				JRadioButton radcontc4 = new JRadioButton("(C) Mendidih");
				JRadioButton radcontd4 = new JRadioButton("(D) Memanas");
				JRadioButton radconte4 = new JRadioButton("(E) Meradang");
				JLabel jawaban4 = new JLabel("Jawaban: C");
				...
				**/
				...
				JLabel penjelasan41 = new JLabel("Siau bermakna sudah tidak panas lagi atau dingin kembali.");
				JLabel penjelasan42 = new JLabel("Mendidih bermakna menjadi panas.");
				...
				JLabel cont5 = new JLabel("5. SINKRON >< ....");
				JRadioButton radconta5 = new JRadioButton("(A) Serasi");
				JRadioButton radcontb5 = new JRadioButton("(B) Selaras");
				JRadioButton radcontc5 = new JRadioButton("(C) Seimbang");
				JRadioButton radcontd5 = new JRadioButton("(D) Sumbang");
				JRadioButton radconte5 = new JRadioButton("(E) Harmonis");
				...
				JLabel penjelasan51 = new JLabel("Sinkron berarti sejalan (dengan); sejajar; sesuai; selaras.");
				JLabel penjelasan52 = new JLabel("Empat pilihan jawaban semua bermakna sama, kecuali sumbang.");
		...
		JLabel label1 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label2 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label3 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label4 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label5 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label6 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label7 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label8 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label9 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label10 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label11 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label12 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label13 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label14 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label15 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label16 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label17 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label18 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label19 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label20 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label21 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label22 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label23 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label24 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label25 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label26 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label27 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label28 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label29 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label30 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label31 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label32 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label33 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label34 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label35 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label36 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label37 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label38 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label39 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label40 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label41 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label42 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label43 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label44 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label45 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label46 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label47 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label48 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label49 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		JLabel label50 = new JLabel("LATIHAN KEMAMPUAN VERBAL ANTONIM");
		...
		JLabel lbl1 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl2 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl3 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl4 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl5 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl6 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl7 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl8 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl9 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl10 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl11 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl12 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl13 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl14 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl15 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl16 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl17 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl18 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl19 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl20 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl21 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl22 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl23 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl24 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl25 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl26 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl27 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl28 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl29 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl30 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl31 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl32 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl33 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl34 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl35 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl36 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl37 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl38 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl39 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl40 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl41 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl42 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl43 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl44 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl45 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl46 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl47 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl48 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl49 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
		JLabel lbl50 = new JLabel("Pilihlah satu jawaban bertanda (A),(B),(C),(D), atau (E) yang mempunyai arti berlawanan atau paling jauh dengan arti kata yang dicetak dengan huruf kapital");
	...
	private class penghendel implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			else if(e.getSource()==kunci)
			{
				...
				rad2d.setForeground(Color.GREEN);
				rad3b.setForeground(Color.GREEN);
				rad4d.setForeground(Color.GREEN);
				rad5a.setForeground(Color.GREEN);
				rad6d.setForeground(Color.GREEN);
				rad7e.setForeground(Color.GREEN);
				rad8c.setForeground(Color.GREEN);
				rad9c.setForeground(Color.GREEN);
				rad10c.setForeground(Color.GREEN);
				rad11d.setForeground(Color.GREEN);
				rad12d.setForeground(Color.GREEN);
				rad13d.setForeground(Color.GREEN);
				rad14c.setForeground(Color.GREEN);
				rad15b.setForeground(Color.GREEN);
				rad16b.setForeground(Color.GREEN);
				rad17b.setForeground(Color.GREEN);
				rad18b.setForeground(Color.GREEN);
				rad19c.setForeground(Color.GREEN);
				rad20c.setForeground(Color.GREEN);
				rad21b.setForeground(Color.GREEN);
				rad22c.setForeground(Color.GREEN);
				...
				rad27c.setForeground(Color.GREEN);
				rad28c.setForeground(Color.GREEN);
				rad29b.setForeground(Color.GREEN);
				rad30b.setForeground(Color.GREEN);
				rad31b.setForeground(Color.GREEN);
				rad32a.setForeground(Color.GREEN);
				rad33d.setForeground(Color.GREEN);
				rad34b.setForeground(Color.GREEN);
				rad35b.setForeground(Color.GREEN);
				rad36d.setForeground(Color.GREEN);
				rad37e.setForeground(Color.GREEN);
				rad38d.setForeground(Color.GREEN);
				rad39c.setForeground(Color.GREEN);
				rad40a.setForeground(Color.GREEN);
				rad41b.setForeground(Color.GREEN);
				rad42b.setForeground(Color.GREEN);
				rad43c.setForeground(Color.GREEN);
				rad44d.setForeground(Color.GREEN);
				rad45b.setForeground(Color.GREEN);
				rad46e.setForeground(Color.GREEN);
				rad47c.setForeground(Color.GREEN);
				rad48c.setForeground(Color.GREEN);
				rad49e.setForeground(Color.GREEN);
			...
			else if(e.getSource()==next50)
			{
				...
				if(rad12d.isSelected())
				{
					point12 = 2;
					benar12 = 1;
				}
				if(rad13d.isSelected())
				{
					point13 = 2;
					benar13 = 1;
				}
				if(rad14c.isSelected())
				{
					point14 = 2;
					benar14 = 1;
				}
				...
				if(rad34b.isSelected())
				{
					point34 = 2;
					benar34 = 1;
				}
				if(rad35b.isSelected())
				{
					point35 = 2;
					benar35 = 1;
				}
				if(rad36d.isSelected())
				{
					point36 = 2;
					benar36 = 1;
				}
				if(rad37e.isSelected())
				{
					point37 = 2;
					benar37 = 1;
				}
				if(rad38d.isSelected())
				{
					point38 = 2;
					benar38 = 1;
				}
				...
				if(rad40a.isSelected())
				{
					point40 = 2;
					benar40 = 1;
				}
				if(rad41b.isSelected())
				{
					point41 = 2;
					benar41 = 1;
				}
				if(rad42b.isSelected())
				{
					point42 = 2;
					benar42 = 1;
				}
	...
	public void clearColorRB()
	{
		...
		rad2d.setForeground(null);
		rad3b.setForeground(null);
		rad4d.setForeground(null);
		rad5a.setForeground(null);
		rad6d.setForeground(null);
		rad7e.setForeground(null);
		rad8c.setForeground(null);
		rad9c.setForeground(null);
		rad10c.setForeground(null);
		rad11d.setForeground(null);
		rad12d.setForeground(null);
		rad13d.setForeground(null);
		rad14c.setForeground(null);
		rad15b.setForeground(null);
		rad16b.setForeground(null);
		rad17b.setForeground(null);
		rad18b.setForeground(null);
		rad19c.setForeground(null);
		rad20c.setForeground(null);
		rad21b.setForeground(null);
		rad22c.setForeground(null);
		rad23a.setForeground(null);
		rad24b.setForeground(null);
		rad25b.setForeground(null);
		rad26a.setForeground(null);
		rad27c.setForeground(null);
		rad28c.setForeground(null);
		rad29b.setForeground(null);
		rad30b.setForeground(null);
		rad31b.setForeground(null);
		rad32a.setForeground(null);
		rad33d.setForeground(null);
		rad34b.setForeground(null);
		rad35b.setForeground(null);
		rad36d.setForeground(null);
		rad37e.setForeground(null);
		rad38d.setForeground(null);
		rad39c.setForeground(null);
		rad40a.setForeground(null);
		rad41b.setForeground(null);
		rad42b.setForeground(null);
		rad43c.setForeground(null);
		rad44d.setForeground(null);
		rad45b.setForeground(null);
		rad46e.setForeground(null);
		rad47c.setForeground(null);
		rad48c.setForeground(null);
		rad49e.setForeground(null);
